...
const session = require('express-session') // создает нужные куки в нужный момент
const FileStore = require('session-file-store')(session); // библиотека для хранения куки

//const { addToLocals } = require('./middleware/allMiddlewares')
